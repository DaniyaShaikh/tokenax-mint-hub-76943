          ...
          <div className="bg-card/10 backdrop-blur-xl rounded-3xl p-12 border border-white/20 shadow-2xl">
            <div className="text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
                <Button 
                  size="lg" 
                  className="group text-lg px-10 py-7 rounded-full bg-white text-primary hover:text-primary hover:bg-white/95 hover:shadow-2xl hover:shadow-white/40 hover:scale-105 transition-all font-bold border-2 border-white"
